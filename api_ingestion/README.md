...
3. The process executes in a ALL or Nothing fashion. **This enables it to be automated to fetch the latest data from the API as it becomes available.** The result tables contain only contains the latest results from NYC OpenData
